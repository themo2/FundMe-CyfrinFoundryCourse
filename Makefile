...
deploy-sepolia :;forge script script/DeployFundMe.s.sol --broadcast --rpc-url $(SEPOLIA_RPC_URL) --account septest --verify --etherscan-api-key $(ETHERSCAN_API_KEY) --chain-id 11155111
